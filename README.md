...
This project showcases SQL skills and techniques commonly used by data analysts to explore, clean, and analyze retail sales data. It involves setting up a retail sales database, conducting exploratory data analysis (EDA), and using SQL queries to answer targeted business questions. It's an excellent starting point for those new to data analysis who want to establish a strong foundation in SQL.
...
- **Customer Demographics**: The dataset includes customers from various age groups, with sales spanning categories like Clothing and Beauty.
- **High-Value Transactions**: Certain transactions exceed 1000 in total sales, pointing to premium purchases.
- **Sales Trends**: Monthly sales analysis reveals fluctuations, highlighting peak sales periods.
...
- **Customer Insights**: Reports on leading customers and unique customer counts per category.
